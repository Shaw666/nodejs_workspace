...
typedef struct
{
	int				x;			//sub window lefttop x coordinate
	int				y;			//sub window lefttop y coordinate
	int				width;		//sub window width
	int				height;		//sub window height
	int				width_projection;//sub window width of projection
	int				height_projection;
	int				theta;		//theta of sub window center 
	int				alpha;		//alpha of sub window center 
	int				len;		
}SUBWIN_INFO;
#endif
...
#ifdef FTRACK_MODE
	SUBWIN_INFO      *subWins;                  /*sub windows info*/ 
#endif
	int              reserved[1];				/*reserved*/
}FISHEYE_OPTPARAM;
...
typedef enum
{
	...
	RENDER_D3D_FAST = 5	 // Must used with DECODE_HW_FAST
...
typedef enum
{
	...
	DECODE_HW_FAST, //GPU DirectRender, Must used with RENDER_D3D_FAST
	DECODE_MSDK		
}DecodeType;
/************************************************************************/
